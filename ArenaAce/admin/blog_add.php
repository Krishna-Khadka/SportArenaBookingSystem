...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `blog`(`title`, `author`,`description`, `image`) VALUES ('{$title}','{$author}','{$description}','{$filename}')";
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-6 mb-3">
                                                            <label for="inputAuthor"
                                                                class="form-label text-black fw-bold">Blog
                                                                Author</label>
                                            ...
                                            <div class="card-body">
                                                <div class="row mb-3">
                                                    ...
                                                    <label for="inputThumbnail"
                                                        class="form-label text-black fw-bold">Blog Thumbnail</label>
                                                    <input type="file" class="form-control" id="inputThumbnail"
                                                        name="thumbnail" placeholder="Enter Blog thumbnail"
