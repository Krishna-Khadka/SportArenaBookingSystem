...
include 'config.php';
  ...
  $sqlArena = " select * from arena where a_id = $eid";
  $arenaQuery = mysqli_query($con,$sqlArena);

  while($row = mysqli_fetch_assoc($arenaQuery)){

    // `name`, `address`, `email`, `phone`, `description`, `latitude`, `longitude`, `thumbnail`, `has_slider` 
...
if (isset($_POST['submit'])) {
    ...
    $U_thumbnail = $_FILES['thumbnail'];
    // $U_sliderImages = $_FILES['slider_images'];
   ...
   $sql =" UPDATE `arena` SET `name`='$U_name',`address`='$U_address',`email`='$U_email',`phone`='$U_phone',`description`='$U_description',`latitude`='$U_latitude',`longitude`='$U_longitude',`thumbnail`='$thumbnailFilename' WHERE a_id=$eid";
    ...
    <div class="row">
                            ...
                            <div class="modal-body">
                                <div class="row mt-3">
                                    <div class="col-lg-6 mb-3">
                                        <label for="inputName" class="form-label text-black fw-bold">Arena Name</label>
                                        <input type="text" class="form-control" name="name" placeholder="Enter Arena Name" value="<?php echo htmlspecialchars($name); ?>">
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label for="inputAddress" class="form-label text-black fw-bold">Address</label>
                                        <input type="text" class="form-control" name="address" placeholder="Enter Arena Address" autocomplete="off" value="<?php echo htmlspecialchars($address); ?>">
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label for="inputEmail" class="form-label text-black fw-bold">Email</label>
                                        <input type="email" class="form-control" name="email" placeholder="Enter Arena Email" value="<?php echo htmlspecialchars($email); ?>">
                                    </div>
                                    <div class="col-lg-6 mb-3">
                                        <label for="inputPhone" class="form-label text-black fw-bold">Phone</label>
                                        <input type="text" class="form-control" name="phone" placeholder="Enter Arena Phone" value="<?php echo htmlspecialchars($phone); ?>">
                                    </div>
                                    <div class="col-lg-12 mb-3">
                                        <label for="description" class="form-label text-black fw-bold">Description</label>
                                        <textarea class="form-control" name="description" id="description" placeholder="Enter Description" cols="30" rows="4" maxlength="250"><?php echo htmlspecialchars($description); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            <div class="row">
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <label for="inputThumbnail" class="form-label text-black fw-bold">Arena Thumbnail</label>
                                <input type="file" class="form-control" id="inputThumbnail" name="thumbnail" placeholder="Enter Arena thumbnail" onchange="previewImage(event)">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-12 mb-3">
                                    <button type="submit" name="point" id="point" class="btn btn-primary">Get My Location</button>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label for="inputPhone" class="form-label text-black fw-bold">Latitude</label>
                                    <input type="text" class="form-control" name="latitude" placeholder="Enter Arena Latitude" value="<?php echo htmlspecialchars($latitude); ?>">
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <label for="inputPhone" class="form-label text-black fw-bold">Longitude</label>
                                    <input type="text" class="form-control" name="longitude" placeholder="Enter Arena Longitude" value="<?php echo htmlspecialchars($longitude); ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <button type="submit" name="submit" class="btn btn-primary">Update Arena</button>
                </div>
            </div>
        </div>
    </div>
